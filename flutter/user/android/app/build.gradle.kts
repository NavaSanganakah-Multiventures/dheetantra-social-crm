...
android {
    ...
    compileOptions {
        ...
        // flutter_local_notifications (Java 8+ APIs) ke liye required
        isCoreLibraryDesugaringEnabled = true
    }

    defaultConfig {
        // TODO: Specify your own unique Application ID (https://developer.android.com/studio/build/application-id.html).
        applicationId = "com.navasanganakah.dheetantra"
        // You can update the following values to match your application needs.
        // For more information, see: https://flutter.dev/to/review-gradle-config.
        // Firebase Messaging ke liye minimum Android 6.0 (API 23) chahiye
    ...
    buildTypes {
        release {
            if (keystorePropertiesFile.exists()) {
                ...
                // key.properties nahi mila: production ke liye release keystore banao
                // (https://docs.flutter.dev/deployment/android#create-an-upload-keystore)
                // aur android/key.properties me set karo. Tab tak debug key se sign hoga.
