...
class _CatalogFormScreenState extends State<CatalogFormScreen> {
  ...
  Future<void> _save() async {
    ...
    if (name.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Naam likhein')));
      return;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(isEdit ? 'Catalog edit karein' : 'Naya catalog')),
      body: ListView(
        ...
        children: [
            ...
            child: Container(
              ...
              child: _imageFile != null
                  ...
                  : _existingImageUrl != null && _existingImageUrl!.isNotEmpty
                      ...
                      : const Center(child: Column(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.add_photo_alternate_outlined, color: AppColors.textMuted), SizedBox(height: 8), Text('Cover image select karein', style: TextStyle(color: AppColors.textMuted))])),
            ),
          ),
          const SizedBox(height: 20),
          TextField(controller: _nameController, decoration: const InputDecoration(labelText: 'Catalog ka naam')),
          ...
          DropdownButtonFormField<String>(
            ...
            items: ['active', 'inactive', 'draft'].map((s) => DropdownMenuItem(value: s, child: Text(s[0].toUpperCase() + s.substring(1)))).toList(),
