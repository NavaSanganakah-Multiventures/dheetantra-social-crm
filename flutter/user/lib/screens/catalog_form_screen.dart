...
class _CatalogFormScreenState extends State<CatalogFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(isEdit ? 'Edit catalog' : 'New catalog')),
      body: ListView(
            ...
            child: Container(
              ...
              child: _imageFile != null
                  ...
                  : _existingImageUrl != null && _existingImageUrl!.isNotEmpty
                      ...
                      : const Center(child: Column(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.add_photo_alternate_outlined, color: AppColors.textMuted), SizedBox(height: 8), Text('Choose cover image', style: TextStyle(color: AppColors.textMuted))])),
            ),
          ),
          const SizedBox(height: 20),
          TextField(controller: _nameController, decoration: const InputDecoration(labelText: 'Catalog name')),
