      ...
      for (const entry of body.entry) {
        for (const change of entry.changes) {
          ...
          if (change.value && change.value.messages) {
            ...
            // not just the first Ã¢ÂÂ otherwise multi-message bursts are dropped.
            ...
            if (message.text) {
              ...
              messageText = message.audio.voice ? 'Ã°ÂÂÂ¤ Voice Note (Ã Â¤ÂÃ Â¤Â¡Ã Â¤Â¿Ã Â¤Â¯Ã Â¥Â Ã Â¤Â¸Ã Â¤ÂÃ Â¤Â¦Ã Â¥ÂÃ Â¤Â¶)' : 'Audio Message (Ã Â¤ÂÃ Â¤Â¡Ã Â¤Â¿Ã Â¤Â¯Ã Â¥Â)';
              messageType = 'audio';
              mediaUrl = message.audio.id;
            } else if (message.sticker) {
              messageText = 'Sticker (Ã Â¤Â¸Ã Â¥ÂÃ Â¤ÂÃ Â¤Â¿Ã Â¤ÂÃ Â¤Â°)';
              messageType = 'sticker';
              ...
              if (message.system && message.system.type === 'user_initiated_call') {
                messageText = 'Ã Â¤ÂÃ Â¤Â¨Ã Â¤ÂÃ Â¤Â®Ã Â¤Â¿Ã Â¤ÂÃ Â¤Â Ã Â¤ÂÃ Â¥ÂÃ Â¤Â² (Incoming Voice Call)';
