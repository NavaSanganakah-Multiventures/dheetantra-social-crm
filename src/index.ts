      ...
      for (const entry of body.entry) {
        for (const change of entry.changes) {
          ...
          if (change.value && change.value.messages) {
            ...
            // not just the first ÃÂ¢ÃÂÃÂ otherwise multi-message bursts are dropped.
            ...
            if (message.text) {
              ...
              messageText = message.audio.voice ? 'ÃÂ°ÃÂÃÂÃÂ¤ Voice Note (ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¤ÃÂ¡ÃÂ ÃÂ¤ÃÂ¿ÃÂ ÃÂ¤ÃÂ¯ÃÂ ÃÂ¥ÃÂ ÃÂ ÃÂ¤ÃÂ¸ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¤ÃÂ¦ÃÂ ÃÂ¥ÃÂÃÂ ÃÂ¤ÃÂ¶)' : 'Audio Message (ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¤ÃÂ¡ÃÂ ÃÂ¤ÃÂ¿ÃÂ ÃÂ¤ÃÂ¯ÃÂ ÃÂ¥ÃÂ)';
              messageType = 'audio';
              mediaUrl = message.audio.id;
            } else if (message.sticker) {
              messageText = 'Sticker (ÃÂ ÃÂ¤ÃÂ¸ÃÂ ÃÂ¥ÃÂÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¤ÃÂ¿ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¤ÃÂ°)';
              messageType = 'sticker';
              ...
              if (message.system && message.system.type === 'user_initiated_call') {
                messageText = 'ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¤ÃÂ¨ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¤ÃÂ®ÃÂ ÃÂ¤ÃÂ¿ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¤ÃÂ ÃÂ ÃÂ¤ÃÂÃÂ ÃÂ¥ÃÂÃÂ ÃÂ¤ÃÂ² (Incoming Voice Call)';
