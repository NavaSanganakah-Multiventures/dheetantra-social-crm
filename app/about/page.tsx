...
const values = [
  {
    ...
    desc: 'Every feature we build starts with a real customer problem.',
    color: 'from-rose-500 to-pink-600',
  },
  {
    icon: <Zap className="w-6 h-6" />,
    title: 'Edge Performance',
    desc: 'Built on Cloudflare Workers for global 0ms latency at scale.',
    color: 'from-amber-500 to-orange-600',
  },
  {
    icon: <Shield className="w-6 h-6" />,
    title: 'Trust & Security',
    desc: 'Enterprise-grade encryption and compliance for your data.',
    color: 'from-blue-500 to-cyan-600',
  },
  {
    icon: <Globe className="w-6 h-6" />,
    title: 'Regional Focus',
    desc: 'Built for Indian businesses with Hindi-first interface and local support.',
      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-surface-900 dark:text-white mb-4 font-['Inter']">
            About <span className="gradient-text">DheeTantra</span>
          </h1>
          <p className="text-lg text-surface-500 dark:text-surface-400 max-w-2xl mx-auto leading-relaxed">
            We are building the next generation of customer communication tools.
            DheeTantra empowers businesses to connect with their audience
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          ...
          >
            ...
            <p className="text-surface-600 dark:text-surface-400 leading-relaxed">
              In a world where customers expect instant, personalized responses
              on their preferred channels, businesses often struggle with
              fragmented inboxes and disconnected tools. Our mission is to unify
              these channels&mdash;WhatsApp, Email, Instagram, and more&mdash;into a
              single, blazing-fast workspace built on edge infrastructure.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-surface-600 dark:text-surface-400 leading-relaxed">
              DheeTantra is proudly built on Cloudflare Workers. This means our
              platform operates at the edge of the network, within milliseconds
              of your users, providing unparalleled speed, reliability, and
              security.
            </p>
          </motion.div>
        </div>
