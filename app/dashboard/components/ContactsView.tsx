            ...
            <form onSubmit={saveContact} className="p-5 overflow-y-auto space-y-4 flex-1">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="sm:col-span-2">
                  <label className="block text-xs font-semibold text-zinc-500 mb-1">पूरा नाम *</label>
                  <input
                    type="text"
                    required
                    value={formName}
                ...
                {/* Primary Phone */}
                <div>
                  <label className="block text-xs font-semibold text-zinc-500 mb-1">मुख्य फ़ोन नंबर *</label>
                  <PhoneInput
                    international
                    defaultCountry="IN"
                    required
                ...
                {/* Email */}
                <div>
                  <label className="block text-xs font-semibold text-zinc-500 mb-1">ईमेल</label>
                  <input
                    type="email"
                    value={formEmail}
                ...
                {/* Gender */}
                <div>
                  <label className="block text-xs font-semibold text-zinc-500 mb-1">लिंग</label>
                  <select
                    value={formGender}
                ...
                <div className="sm:col-span-2 bg-zinc-50 dark:bg-zinc-800/20 p-4 rounded-xl border border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
                  <div>
                    <h4 className="text-xs font-bold text-zinc-800 dark:text-zinc-200">क्या यह लीड है?</h4>
                ...
                {formIsLead && (
                  <div className="sm:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4 bg-indigo-50/20 dark:bg-indigo-950/5 p-4 rounded-xl border border-indigo-100/50 dark:border-indigo-900/10">
                    ...
                    <div>
                      <label className="block text-xs font-semibold text-zinc-500 mb-1">अनुमानित मूल्य (₹)</label>
                      <input
                        type="number"
                        value={formLeadValue}
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl w-full max-w-sm overflow-hidden shadow-2xl border border-zinc-200 dark:border-zinc-800 animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="p-5 space-y-4">
              <div>
                <label className="block text-xs font-semibold text-zinc-500 mb-2">कॉपी फॉरमैट</label>
