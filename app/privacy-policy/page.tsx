  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 font-sans selection:bg-indigo-500/30">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-bold font-display text-zinc-900 dark:text-white mb-8">Privacy Policy</h1>
        ...
        <div className="space-y-8 text-zinc-600 dark:text-zinc-400 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-zinc-900 dark:text-white">1. Information We Collect</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-zinc-900 dark:text-white">2. How We Use Your Information</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-zinc-900 dark:text-white">4. Data Sharing and Disclosure</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-zinc-900 dark:text-white">5. Your Privacy Rights</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-zinc-900 dark:text-white">6. Contact Us</h2>
            <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:support@dheetantra.com" className="text-indigo-600 dark:text-indigo-400 hover:underline">support@dheetantra.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
