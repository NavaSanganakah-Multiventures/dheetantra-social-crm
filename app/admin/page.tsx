...
export default function AdminDashboard() {
  ...
  const loadStats = () => {
    ...
    fetch('/api/admin/stats')
      ...
      .catch(() => {
        addNotification('à¤¸à¤¾à¤à¤à¥à¤¯à¤¿à¤à¥ à¤²à¥à¤¡ à¤à¤°à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
        setLoadingStats(false);
      });
  };
  ...
  const loadUsers = () => {
    ...
    fetch('/api/admin/users')
      ...
      .catch(() => {
        addNotification('à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤²à¥à¤¡ à¤à¤°à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
        setLoadingUsers(false);
      });
  };
  ...
  const loadWorkspaces = () => {
    ...
    fetch('/api/admin/workspaces')
      ...
      .catch(() => {
        addNotification('à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤²à¥à¤¡ à¤à¤°à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
        setLoadingWorkspaces(false);
      });
  };
  ...
  const loadPlans = () => {
    ...
    fetch('/api/admin/plans')
      ...
      .catch(() => {
        addNotification('à¤¸à¤¬à¥à¤¸à¤à¥à¤°à¤¿à¤ªà¥à¤¶à¤¨ à¤ªà¥à¤²à¤¾à¤¨à¥à¤¸ à¤²à¥à¤¡ à¤à¤°à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
        setLoadingPlans(false);
      });
  };
  ...
  const loadAdminDomains = () => {
    ...
    fetch(endpoint)
      ...
      .catch(() => {
        addNotification('à¤¡à¥à¤®à¥à¤¨ à¤²à¥à¤¡ à¤à¤°à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
        setLoadingAdminDomains(false);
      });
  };
  ...
  const reviewDomain = async (id: string, action: 'approve' | 'reject' | 'unsuspend', reason?: string) => {
    try {
      ...
      if (res.ok) {
        addNotification(
          action === 'approve' ? 'à¤¡à¥à¤®à¥à¤¨ approve à¤¹à¥ à¤à¤¯à¤¾'
          : action === 'unsuspend' ? 'à¤¡à¥à¤®à¥à¤¨ unsuspend à¤¹à¥ à¤à¤¯à¤¾'
          : 'à¤¡à¥à¤®à¥à¤¨ reject à¤¹à¥ à¤à¤¯à¤¾'
        );
        loadAdminDomains();
      } else {
      ...
      addNotification('à¤¸à¤°à¥à¤µà¤° à¤à¤°à¤°', 'error');
    }
  };
  ...
  const loadKvSecrets = () => {
    ...
    fetch('/api/admin/kv')
      ...
      .catch(() => {
        addNotification('KV à¤¸à¥à¤à¥à¤°à¥à¤à¥à¤¸ à¤²à¥à¤¡ à¤à¤°à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
        setLoadingKv(false);
      });
  };
  ...
  const loadSchemaDiff = () => {
    ...
    fetch('/api/admin/schema-diff')
      ...
      .catch(() => {
        addNotification('à¤¡à¥à¤à¤¾à¤¬à¥à¤¸ à¤¸à¥à¤¥à¤¿à¤¤à¤¿ à¤²à¥à¤¡ à¤à¤°à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
        setLoadingDiff(false);
      });
  };
  ...
  const saveUser = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data: any = await res.json();
      if (res.ok) {
        addNotification(userModal.mode === 'create' ? 'à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤ªà¤à¤à¥à¤à¥à¤¤' : 'à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤à¤ªà¤¡à¥à¤ à¤à¤¿à¤¯à¤¾ à¤à¤¯à¤¾');
        setUserModal({ open: false, mode: 'create' });
        loadUsers();
      } else {
        addNotification(data.error || 'à¤à¤ªà¤°à¥à¤¶à¤¨ à¤µà¤¿à¤«à¤² à¤°à¤¹à¤¾', 'error');
      }
    } catch {
      addNotification('à¤¸à¤°à¥à¤µà¤° à¤à¤°à¤°', 'error');
    }
  ...
  const deleteUser = async (id: string) => {
    if (!confirm('à¤à¥à¤¯à¤¾ à¤à¤ª à¤µà¤¾à¤à¤ à¤à¤¸ à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤à¥ à¤¹à¤à¤¾à¤¨à¤¾ à¤à¤¾à¤¹à¤¤à¥ à¤¹à¥à¤?')) return;
    try {
      const res = await fetch(`/api/admin/users/${id}`, { method: 'DELETE' });
      if (res.ok) {
        addNotification('à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤à¥ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤¹à¤à¤¾ à¤¦à¤¿à¤¯à¤¾ à¤à¤¯à¤¾ à¤¹à¥');
        loadUsers();
      } else {
        addNotification('à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤à¥ à¤¹à¤à¤¾à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
      }
  ...
  const saveWorkspace = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Only send owner_id when provided â prevents wiping the workspace owner on edit
      ...
      const data: any = await res.json();
      if (res.ok) {
        addNotification(workspaceModal.mode === 'create' ? 'à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤¨à¤¿à¤°à¥à¤®à¤¿à¤¤' : 'à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤à¤ªà¤¡à¥à¤');
  ...
  const deleteWorkspace = async (id: string) => {
    if (!confirm('à¤à¥à¤¯à¤¾ à¤à¤ª à¤µà¤¾à¤à¤ à¤à¤¸ à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤à¥ à¤¹à¤à¤¾à¤¨à¤¾ à¤à¤¾à¤¹à¤¤à¥ à¤¹à¥à¤?')) return;
    try {
      const res = await fetch(`/api/admin/workspaces/${id}`, { method: 'DELETE' });
      if (res.ok) {
        addNotification('à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤à¥ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤¹à¤à¤¾ à¤¦à¤¿à¤¯à¤¾ à¤à¤¯à¤¾ à¤¹à¥');
        loadWorkspaces();
      } else {
        addNotification('à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤à¥ à¤¹à¤à¤¾à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
      }
  ...
  const savePlan = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data: any = await res.json();
      if (res.ok) {
        addNotification(planModal.mode === 'create' ? 'à¤ªà¥à¤²à¤¾à¤¨ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤à¥à¤¡à¤¼à¤¾ à¤à¤¯à¤¾' : 'à¤ªà¥à¤²à¤¾à¤¨ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤à¤ªà¤¡à¥à¤ à¤à¤¿à¤¯à¤¾ à¤à¤¯à¤¾');
...
const deletePlan = async (id: string) => {
    if (!confirm('à¤à¥à¤¯à¤¾ à¤à¤ª à¤µà¤¾à¤à¤ à¤à¤¸ à¤ªà¥à¤²à¤¾à¤¨ à¤à¥ à¤¹à¤à¤¾à¤¨à¤¾ à¤à¤¾à¤¹à¤¤à¥ à¤¹à¥à¤?')) return;
    try {
      const res = await fetch(`/api/admin/plans/${id}`, { method: 'DELETE' });
      if (res.ok) {
        addNotification('à¤ªà¥à¤²à¤¾à¤¨ à¤à¥ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤¹à¤à¤¾ à¤¦à¤¿à¤¯à¤¾ à¤à¤¯à¤¾ à¤¹à¥');
        loadPlans();
      } else {
        addNotification('à¤ªà¥à¤²à¤¾à¤¨ à¤¹à¤à¤¾à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
      }
    } catch {
      addNotification('à¤¸à¤°à¥à¤µà¤° à¤à¤°à¤°', 'error');
    }
  ...
  const saveKvSecret = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const data: any = await res.json();
      if (res.ok) {
        addNotification('KV à¤¸à¥à¤à¥à¤°à¥à¤ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤¸à¤¹à¥à¤à¤¾ à¤à¤¯à¤¾');
        setKvModal({ open: false });
        loadKvSecrets();
      } else {
        addNotification(data.error || 'à¤¸à¤¹à¥à¤à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
      }
    } catch {
      addNotification('à¤¸à¤°à¥à¤µà¤° à¤à¤°à¤°', 'error');
    }
  ...
  const deleteKvSecret = async (keyName: string) => {
    if (!confirm(`à¤à¥à¤¯à¤¾ à¤à¤ª à¤µà¤¾à¤à¤ KV à¤à¥ "${keyName}" à¤à¥ à¤¹à¤à¤¾à¤¨à¤¾ à¤à¤¾à¤¹à¤¤à¥ à¤¹à¥à¤?`)) return;
    try {
      const res = await fetch(`/api/admin/kv/${encodeURIComponent(keyName)}`, { method: 'DELETE' });
      if (res.ok) {
        addNotification('KV à¤à¥ à¤¸à¤«à¤²à¤¤à¤¾à¤ªà¥à¤°à¥à¤µà¤ à¤¹à¤à¤¾à¤ à¤à¤');
        loadKvSecrets();
      } else {
        addNotification('à¤¹à¤à¤¾à¤¨à¥ à¤®à¥à¤ à¤µà¤¿à¤«à¤²', 'error');
      }
    } catch {
      addNotification('à¤¸à¤°à¥à¤µà¤° à¤à¤°à¤°', 'error');
    }
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-surface-950 text-white">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-surface-400 font-mono tracking-wide">à¤ªà¥à¤°à¤¶à¤¾à¤¸à¤ à¤à¥à¤°à¥à¤¡à¥à¤à¤¶à¤¿à¤¯à¤²à¥à¤¸ à¤à¥ à¤à¤¾à¤à¤ à¤à¥ à¤à¤¾ à¤°à¤¹à¥ à¤¹à¥...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-surface-950 text-white px-4">
        ...
        >
          ...
          <h2 className="text-xl font-bold mb-2 font-display">à¤à¤¸à¥à¤µà¥à¤à¥à¤¤ à¤ªà¥à¤°à¤µà¥à¤¶ (Access Denied)</h2>
          <p className="text-surface-400 text-sm mb-6 leading-relaxed">
            à¤à¤ªà¤à¥ à¤ªà¤¾à¤¸ à¤à¤¸ à¤µà¥à¤¯à¤µà¤¸à¥à¤¥à¤¾à¤ªà¤ à¤à¤à¤¸à¥à¤² à¤à¥ à¤à¤à¥à¤¸à¥à¤¸ à¤à¤°à¤¨à¥ à¤à¤¾ à¤à¤§à¤¿à¤à¤¾à¤° à¤¨à¤¹à¥à¤ à¤¹à¥à¥¤ à¤¯à¤¹ à¤ªà¥à¤·à¥à¤  à¤à¥à¤µà¤² à¤à¤§à¤¿à¤à¥à¤¤ à¤¸à¤¿à¤¸à¥à¤à¤® à¤ªà¥à¤°à¤¶à¤¾à¤¸à¤à¥à¤ à¤à¥ à¤²à¤¿à¤ à¤à¤°à¤à¥à¤·à¤¿à¤¤ à¤¹à¥à¥¤
          </p>
          <div className="flex flex-col gap-3">
            ...
            >
              ...
              à¤à¥à¤²à¤¾à¤à¤à¤ à¤¡à¥à¤¶à¤¬à¥à¤°à¥à¤¡ à¤ªà¤° à¤µà¤¾à¤ªà¤¸ à¤à¤¾à¤à¤
            </button>
            <button 
    ...
    <div className="flex h-screen overflow-hidden bg-surface-950 text-surface-100 font-sans">
      ...
      <aside className={`w-72 bg-surface-900 border-r border-surface-800 flex flex-col flex-shrink-0 fixed md:static inset-y-0 left-0 z-50 transition-transform duration-200 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        <div className="p-6 border-b border-surface-800 flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-base tracking-tight text-white font-display">à¤ªà¥à¤°à¤¶à¤¾à¤¸à¤ à¤à¤à¤¸à¥à¤²</h1>
        ...
        <nav className="flex-1 min-h-0 px-4 py-6 space-y-2 overflow-y-auto">
          <div className="text-[10px] font-bold text-surface-500 uppercase tracking-widest mb-4 px-3">à¤à¤à¤à¥à¤°à¥à¤² à¤¸à¥à¤à¤à¤°</div>
          
          <SidebarButton 
            icon={<LayoutDashboard className="w-4 h-4" />} 
            label="à¤à¤µà¤²à¥à¤à¤¨ (Overview)" 
            active={activeTab === 'overview'} 
            onClick={() => { setActiveTab('overview'); setSidebarOpen(false); }} 
          />
          <SidebarButton 
            icon={<Users className="w-4 h-4" />} 
            label="à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ (Users)" 
            active={activeTab === 'users'} 
            onClick={() => { setActiveTab('users'); setSidebarOpen(false); }} 
          />
          <SidebarButton 
            icon={<Building2 className="w-4 h-4" />} 
            label="à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ (Workspaces)" 
            active={activeTab === 'workspaces'} 
            onClick={() => { setActiveTab('workspaces'); setSidebarOpen(false); }} 
          />
          <SidebarButton 
            icon={<CreditCard className="w-4 h-4" />} 
            label="à¤¸à¤¬à¥à¤¸à¤à¥à¤°à¤¿à¤ªà¥à¤¶à¤¨ à¤ªà¥à¤²à¤¾à¤¨à¥à¤¸" 
            active={activeTab === 'plans'} 
            onClick={() => { setActiveTab('plans'); setSidebarOpen(false); }} 
          />
          <SidebarButton 
            icon={<Globe className="w-4 h-4" />} 
            label="à¤¡à¥à¤®à¥à¤¨ à¤°à¤¿à¤µà¥à¤¯à¥ (Email)" 
            active={activeTab === 'domains'} 
            onClick={() => { setActiveTab('domains'); setSidebarOpen(false); }} 
          />
          <SidebarButton 
            icon={<Key className="w-4 h-4" />} 
            label="KV à¤¸à¤¿à¤¸à¥à¤à¤® à¤¸à¥à¤à¥à¤°à¥à¤à¥à¤¸" 
            active={activeTab === 'kv'} 
            onClick={() => { setActiveTab('kv'); setSidebarOpen(false); }} 
          />
          <SidebarButton 
            icon={<Database className="w-4 h-4" />} 
            label="à¤¡à¥à¤à¤¾à¤¬à¥à¤¸ (Database)" 
        ...
        <header className="h-16 border-b border-surface-800 bg-surface-900/60 flex items-center justify-between px-4 md:px-8">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-white capitalize font-display">
              {activeTab === 'overview' && 'à¤¸à¤¿à¤¸à¥à¤à¤® à¤à¤µà¤²à¥à¤à¤¨'}
              {activeTab === 'users' && 'à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤ªà¥à¤°à¤¬à¤à¤§à¤¨'}
              {activeTab === 'workspaces' && 'à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤ªà¥à¤°à¤¬à¤à¤§à¤¨'}
              {activeTab === 'plans' && 'à¤ªà¥à¤²à¤¾à¤¨ à¤à¥à¤à¤²à¥à¤'}
              {activeTab === 'domains' && 'à¤¡à¥à¤®à¥à¤¨ à¤°à¤¿à¤µà¥à¤¯à¥ (Email Domains)'}
              {activeTab === 'kv' && 'KV à¤à¥à¤²à¤¾à¤à¤¡ à¤¸à¥à¤à¥à¤°à¥à¤à¥à¤¸'}
              {activeTab === 'database' && 'à¤¡à¥à¤à¤¾à¤¬à¥à¤¸ (Database)'}
            </h2>
          ...
          <div className="flex items-center gap-4">
            <button 
              onClick={() => {
                ...
                if (activeTab === 'kv') loadKvSecrets();
                if (activeTab === 'database') loadSchemaDiff();
                addNotification('à¤¡à¤¾à¤à¤¾ à¤°à¤¿à¤«à¥à¤°à¥à¤¶ à¤à¤¿à¤¯à¤¾ à¤à¤¯à¤¾');
              }}
          ...
          <AnimatePresence mode="wait">
            {activeTab === 'overview' && (
              ...
              >
                ...
                {loadingStats ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                    <StatCard title="à¤à¥à¤² à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ (Users)" value={stats?.users || '0'} icon={<Users className="w-5 h-5 text-primary-400" />} subtitle="CRM à¤à¤° à¤¸à¥à¤à¤¾à¤« à¤¸à¤¦à¤¸à¥à¤¯" />
                    <StatCard title="à¤¸à¤à¥à¤°à¤¿à¤¯ à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸" value={stats?.workspaces || '0'} icon={<Building2 className="w-5 h-5 text-violet-400" />} subtitle="à¤µà¤¿à¤­à¤¾à¤à¥à¤¯ à¤¸à¤à¤à¤ à¤¨" />
                    <StatCard title="WABA à¤«à¥à¤¨ à¤¨à¤à¤¬à¤°" value={stats?.whatsapp || '0'} icon={<Database className="w-5 h-5 text-emerald-400" />} subtitle="Meta APIs à¤à¤¨à¥à¤à¥à¤à¥à¤¡" />
                    <StatCard title="à¤µà¥à¤¹à¤¾à¤à¥à¤¸à¤à¤ª à¤¸à¤à¤¦à¥à¤¶" value={stats?.messages || '0'} icon={<Activity className="w-5 h-5 text-sky-400" />} subtitle="à¤¸à¤¿à¤¸à¥à¤à¤® à¤¥à¥à¤°à¥à¤ªà¥à¤ à¤µà¥à¤²à¥à¤¯à¥à¤®" />
                  </div>
                )}
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 bg-surface-900 border border-surface-800 rounded-3xl p-6 relative overflow-hidden">
                    ...
                    <h3 className="text-sm font-semibold tracking-wide uppercase text-surface-400 mb-6">à¤¸à¤¿à¤¸à¥à¤à¤® à¤¸à¥à¤µà¤¾à¤¸à¥à¤¥à¥à¤¯ à¤à¤° à¤¬à¥à¤¨à¤¿à¤¯à¤¾à¤¦à¥ à¤¢à¤¾à¤à¤à¤¾</h3>
                    ...
                    <div className="mt-6 flex gap-4 pt-6 border-t border-surface-800/60">
                      <div className="text-center p-3 bg-surface-950/30 rounded-xl border border-surface-800/40 flex-1">
                        <p className="text-[10px] text-surface-500">à¤¸à¤à¤ªà¤°à¥à¤ à¤²à¥à¤¡à¥à¤¸</p>
                        <p className="text-lg font-bold text-white mt-1">{stats?.contacts || '0'}</p>
                      </div>
                      <div className="text-center p-3 bg-surface-950/30 rounded-xl border border-surface-800/40 flex-1">
                        <p className="text-[10px] text-surface-500">à¤¬à¥à¤°à¥à¤¡à¤à¤¾à¤¸à¥à¤ à¤à¥à¤à¤ªà¥à¤¨</p>
                        <p className="text-lg font-bold text-white mt-1">{stats?.campaigns || '0'}</p>
                      </div>
                      <div className="text-center p-3 bg-surface-950/30 rounded-xl border border-surface-800/40 flex-1">
                        <p className="text-[10px] text-surface-500">à¤à¥à¤² à¤°à¤¿à¤à¥à¤°à¥à¤¡à¥à¤¸</p>
                  ...
                  <div className="bg-surface-900 border border-surface-800 rounded-3xl p-6">
                    <h3 className="text-sm font-semibold tracking-wide uppercase text-surface-400 mb-6">à¤¤à¥à¤µà¤°à¤¿à¤¤ à¤ªà¥à¤°à¤¶à¤¾à¤¸à¤¨à¤¿à¤ à¤à¥à¤°à¤¿à¤¯à¤¾à¤à¤</h3>
                    <div className="space-y-3">
                      <QuickActionButton label="à¤¨à¤¯à¤¾ à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤ªà¤à¤à¥à¤à¥à¤¤ à¤à¤°à¥à¤" onClick={() => { setUserModal({ open: true, mode: 'create' }); setUserForm({ name: '', email: '', is_registered: true }); setActiveTab('users'); }} />
                      <QuickActionButton label="à¤¨à¤¯à¤¾ à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤¬à¤¨à¤¾à¤à¤" onClick={() => { setWorkspaceModal({ open: true, mode: 'create' }); setWorkspaceForm({ name: '', plan_id: '', owner_id: '' }); setActiveTab('workspaces'); }} />
                      <QuickActionButton label="à¤¸à¤¬à¥à¤¸à¤à¥à¤°à¤¿à¤ªà¥à¤¶à¤¨ à¤ªà¥à¤²à¤¾à¤¨ à¤à¥à¤¡à¤¼à¥à¤" onClick={() => { setPlanModal({ open: true, mode: 'create' }); setPlanForm(defaultPlanForm); setActiveTab('plans'); }} />
                      <QuickActionButton label="KV à¤¸à¥à¤à¥à¤°à¥à¤ à¤à¥à¤à¤à¥ à¤à¥à¤¡à¤¼à¥à¤" onClick={() => { setKvModal({ open: true }); setKvForm({ name: '', value: '' }); setActiveTab('kv'); }} />
                    </div>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="relative flex-1 max-w-md">
                    ...
                    <input 
                      type="text" 
                      placeholder="à¤¨à¤¾à¤® à¤¯à¤¾ à¤à¤®à¥à¤² à¤¦à¥à¤µà¤¾à¤°à¤¾ à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤à¥à¤à¥à¤..." 
                      value={userSearch}
                  ...
                  >
                    ...
                    à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤ªà¤à¤à¥à¤à¥à¤¤ à¤à¤°à¥à¤
                  </button>
                </div>
                ...
                <div className="bg-surface-900 border border-surface-800 rounded-3xl overflow-hidden shadow-sm">
                  {loadingUsers ? (
                    <div className="p-8 text-center text-surface-500 text-xs">à¤²à¥à¤¡ à¤¹à¥ à¤°à¤¹à¤¾ à¤¹à¥...</div>
                  ) : filteredUsers.length === 0 ? (
                    <div className="p-12 text-center text-surface-500 space-y-2">
                      <Users className="w-10 h-10 text-surface-700 mx-auto" />
                      <p className="text-xs">à¤à¥à¤ à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤¨à¤¹à¥à¤ à¤®à¤¿à¤²à¤¾</p>
                    </div>
                  ) : (
                      ...
                      <table className="w-full text-left border-collapse">
                        <thead>
                          <tr className="border-b border-surface-800 bg-surface-950/30 text-[10px] font-bold tracking-wider text-surface-400 uppercase">
                            <th className="px-6 py-4">à¤¨à¤¾à¤® (Name)</th>
                            <th className="px-6 py-4">à¤à¤®à¥à¤² (Email)</th>
                            <th className="px-6 py-4">à¤ªà¤à¤à¥à¤à¤°à¤£ à¤¸à¥à¤¥à¤¿à¤¤à¤¿</th>
                            <th className="px-6 py-4">à¤¦à¤¿à¤¨à¤¾à¤à¤</th>
                            <th className="px-6 py-4 text-right">à¤à¤¾à¤°à¥à¤¯</th>
                          </tr>
                        </thead>
                            ...
                            <tr key={u.id} className="hover:bg-surface-800/20 transition-colors">
                              ...
                              <td className="px-6 py-4">
                                <span className={`px-2 py-0.5 rounded-full text-[10px] font-semibold border ${
                                  ...
                                  {u.is_registered ? 'à¤ªà¤à¤à¥à¤à¥à¤¤ (Active)' : 'à¤²à¤à¤¬à¤¿à¤¤ (Pending)'}
                                </span>
                              </td>
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="relative flex-1 max-w-md">
                    ...
                    <input 
                      type="text" 
                      placeholder="à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤¯à¤¾ à¤¸à¤¦à¤¸à¥à¤¯à¥à¤ à¤¦à¥à¤µà¤¾à¤°à¤¾ à¤à¥à¤à¥à¤..." 
                ...
                <div className="bg-surface-900 border border-surface-800 rounded-3xl overflow-hidden shadow-sm">
                  {loadingWorkspaces ? (
                    ...
                    <div className="p-12 text-center text-surface-500 space-y-2">
                      ...
                      <p className="text-xs">à¤à¥à¤ à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤¨à¤¹à¥à¤ à¤®à¤¿à¤²à¤¾</p>
                    </div>
                  ) : (
                    <div className="overflow-x-auto">
                      <table className="w-full text-left border-collapse">
                        <thead>
                          <tr className="border-b border-surface-800 bg-surface-950/30 text-[10px] font-bold tracking-wider text-surface-400 uppercase">
                            <th className="px-6 py-4">à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤à¤¾ à¤¨à¤¾à¤® (Workspace Name)</th>
                            <th className="px-6 py-4">ID</th>
                            <th className="px-6 py-4">à¤¸à¤à¤¬à¤¦à¥à¤§ à¤ªà¥à¤²à¤¾à¤¨ (Plan)</th>
                            <th className="px-6 py-4">à¤¸à¤¦à¤¸à¥à¤¯ à¤à¤®à¥à¤² (Members)</th>
                            <th className="px-6 py-4 text-right">à¤à¤¾à¤°à¥à¤¯</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-surface-800/60 text-xs text-surface-300">
            ...
            {activeTab === 'plans' && (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  <p className="text-xs text-surface-400">à¤ªà¥à¤²à¥à¤à¤«à¤¼à¥à¤°à¥à¤® à¤ªà¤° à¤à¤ªà¤²à¤¬à¥à¤§ à¤µà¤¿à¤­à¤¿à¤¨à¥à¤¨ à¤¸à¤¦à¤¸à¥à¤¯à¤¤à¤¾ à¤¯à¥à¤à¤¨à¤¾à¤à¤ à¤à¥ à¤ªà¥à¤°à¤¬à¤à¤§à¤¿à¤¤ à¤à¤°à¥à¤à¥¤</p>
                  <button 
                    onClick={() => {
                  ...
                  >
                    <Plus className="w-4 h-4" />
                    à¤ªà¥à¤²à¤¾à¤¨ à¤à¥à¤¡à¤¼à¥à¤ (Add Plan)
                  </button>
                </div>
                ...
                {loadingPlans ? (
                  ...
                  <div className="p-12 text-center bg-surface-900 border border-surface-800 rounded-3xl text-surface-500">
                    ...
                    <p className="text-xs">à¤à¥à¤ à¤¸à¤¦à¤¸à¥à¤¯à¤¤à¤¾ à¤ªà¥à¤²à¤¾à¤¨ à¤¨à¤¹à¥à¤ à¤®à¤¿à¤²à¤¾</p>
                  </div>
                ) : (
                      ...
                      return (
                        <div key={p.id} className="bg-surface-900 border border-surface-800 rounded-3xl p-6 flex flex-col justify-between hover:border-primary-500/30 transition-all relative overflow-hidden group">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-surface-400 mb-6">{p.description || 'à¤à¥à¤ à¤µà¤¿à¤µà¤°à¤£ à¤à¤ªà¤²à¤¬à¥à¤§ à¤¨à¤¹à¥à¤ à¤¹à¥à¥¤'}</p>
                            ...
                            <div className="flex flex-wrap gap-1.5 mb-4">
                              ...
                              <span className="text-[10px] font-semibold px-2 py-0.5 rounded-lg bg-surface-800 text-surface-300 border border-surface-700/30 font-mono">
                                {p.currency || 'INR'} Â· {p.billing_period || 'monthly'} ({p.billing_interval || 1})
                              </span>
                              {p.is_active !== 1 && (
                            ...
                            <div className="space-y-4 mb-6">
                              <div className="flex items-baseline gap-1 bg-surface-950/40 p-3 rounded-2xl border border-surface-800/40">
                                <span className="text-2xl font-bold text-white font-display">â¹{p.upfront_price}</span>
                                <span className="text-[10px] text-surface-500">{p.billing_type === 'recurring' ? '/ à¤®à¤¹à¥à¤¨à¤¾' : 'one-time'}</span>
                              </div>
                              <div className="text-xs text-primary-400 bg-primary-500/5 py-1.5 px-3 rounded-xl inline-block border border-primary-500/10 font-mono text-[10px]">
                                PAYG à¤¦à¤°: â¹{p.pay_as_you_go_rate} / à¤¸à¤à¤¦à¥à¤¶
                              </div>
                            </div>

                            <div className="space-y-2">
                              <p className="text-[10px] font-bold text-surface-500 uppercase tracking-widest">à¤¶à¤¾à¤®à¤¿à¤² à¤µà¤¿à¤¶à¥à¤·à¤¤à¤¾à¤à¤ (Features):</p>
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  <p className="text-xs text-surface-400">
                    Customer à¤à¥ à¤¦à¥à¤µà¤¾à¤°à¤¾ à¤à¥à¤¡à¤¼à¥ à¤à¤ custom domains admin approve à¤à¤°à¤¨à¥ à¤à¥ à¤¬à¤¾à¤¦ à¤¹à¥ Cloudflare à¤ªà¤° onboard à¤¹à¥à¤à¤à¥à¥¤
                  </p>
                ...
                {loadingAdminDomains ? (
                  ...
                  <div className="bg-surface-900 border border-surface-800 rounded-3xl p-12 text-center text-surface-500">
                    ...
                    <p className="text-xs">à¤à¥à¤ domain à¤¨à¤¹à¥à¤ à¤®à¤¿à¤²à¤¾</p>
                  </div>
                ) : (
              ...
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="relative flex-1 max-w-md">
                    ...
                    <input 
                      type="text" 
                      placeholder="à¤¸à¥à¤à¥à¤°à¥à¤ à¤à¥à¤à¤à¥ à¤¯à¤¾ à¤®à¥à¤²à¥à¤¯ à¤¦à¥à¤µà¤¾à¤°à¤¾ à¤à¥à¤à¥à¤..." 
                      value={kvSearch}
                  ...
                  >
                    <Plus className="w-4 h-4" />
                    KV à¤à¥-à¤µà¥à¤²à¥à¤¯à¥ à¤à¥à¤¡à¤¼à¥à¤
                  </button>
                </div>
                ...
                <div className="bg-surface-900 border border-surface-800 rounded-3xl overflow-hidden shadow-sm">
                  {loadingKv ? (
                    ...
                    <div className="p-12 text-center text-surface-500 space-y-2">
                      ...
                      <p className="text-xs">à¤à¥à¤ à¤¸à¥à¤à¥à¤°à¥à¤ à¤à¥à¤à¤à¥ à¤¨à¤¹à¥à¤ à¤®à¤¿à¤²à¥</p>
                    </div>
                  ) : (
                    <div className="overflow-x-auto">
                      <table className="w-full text-left border-collapse">
                        <thead>
                          <tr className="border-b border-surface-800 bg-surface-950/30 text-[10px] font-bold tracking-wider text-surface-400 uppercase">
                            <th className="px-6 py-4">à¤à¥à¤à¤à¥ à¤¨à¤¾à¤® (Key Name)</th>
                            <th className="px-6 py-4">à¤®à¥à¤²à¥à¤¯ (Secret Value)</th>
                            <th className="px-6 py-4 text-right">à¤à¤¾à¤°à¥à¤¯</th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-surface-800/60 text-xs text-surface-300">
                          {filteredKvKeys.map(k => {
                            ...
                            const displayVal = isRevealed ? (k.value ?? '') : 'â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢â¢';
                                  ...
                                  <div className="flex items-center justify-end gap-2">
                                    {!(k.value || '').startsWith('[') && (
                                      <button 
                                        ...
                                        className="p-1.5 hover:bg-surface-800 rounded-lg text-surface-400 hover:text-white transition-colors"
                                        title={isRevealed ? "à¤à¤¿à¤ªà¤¾à¤à¤" : "à¤¦à¥à¤à¥à¤"}
                                      >
            ...
            {activeTab === 'database' && (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div>
                    <h2 className="text-xl font-bold text-white mb-1">à¤¡à¥à¤à¤¾à¤¬à¥à¤¸ à¤®à¤¾à¤à¤à¥à¤°à¥à¤¶à¤¨ (Database Migration)</h2>
                    <p className="text-sm text-surface-400">à¤¸à¥à¤à¥à¤®à¤¾ à¤à¥ à¤à¤¾à¤à¤ à¤à¤°à¥à¤ à¤à¤° à¤¸à¥à¤°à¤à¥à¤·à¤¿à¤¤ à¤°à¥à¤ª à¤¸à¥ à¤¡à¥à¤à¤¾à¤¬à¥à¤¸ à¤à¤ªà¤¡à¥à¤ à¤à¤°à¥à¤</p>
                  </div>
                  <div className="flex items-center gap-3">
                    <button 
                    ...
                    {schemaDiff?.status === 'needs_migration' && (
                      <button 
                        onClick={async () => {
                          if (confirm("à¤à¥à¤¯à¤¾ à¤à¤ª à¤¸à¥à¤¨à¤¿à¤¶à¥à¤à¤¿à¤¤ à¤¹à¥à¤ à¤à¤¿ à¤à¤ª à¤¡à¥à¤à¤¾à¤¬à¥à¤¸ à¤¸à¥à¤à¥à¤®à¤¾ à¤à¥ à¤®à¤¾à¤à¤à¥à¤°à¥à¤ à¤à¤°à¤¨à¤¾ à¤à¤¾à¤¹à¤¤à¥ à¤¹à¥à¤?")) {
                            setLoadingDiff(true);
                            try {
                              ...
                              if (res.ok) {
                                ...
                                addNotification(data.error || 'à¤®à¤¾à¤à¤à¥à¤°à¥à¤¶à¤¨ à¤µà¤¿à¤«à¤² à¤°à¤¹à¤¾', 'error');
                                setLoadingDiff(false);
                              }
                            } catch {
                              addNotification('à¤¸à¤°à¥à¤µà¤° à¤à¤°à¤°', 'error');
                ...
                <div className="bg-surface-900 border border-surface-800 rounded-3xl overflow-hidden shadow-sm p-8">
                  {loadingDiff ? (
                    ...
                    <div className="text-center py-12 text-surface-500">à¤¡à¥à¤à¤¾ à¤²à¥à¤¡ à¤¨à¤¹à¥à¤ à¤¹à¥ à¤ªà¤¾à¤¯à¤¾</div>
                    ...
                    <div className="flex flex-col items-center justify-center py-12 space-y-4">
                      ...
                      <div className="text-center">
                        <h3 className="text-lg font-bold text-white mb-1">à¤¡à¥à¤à¤¾à¤¬à¥à¤¸ à¤¸à¥à¤à¥à¤®à¤¾ à¤ªà¥à¤°à¥ à¤¤à¤°à¤¹ à¤à¤ªà¤¡à¥à¤ à¤¹à¥</h3>
                        <p className="text-sm text-surface-500">à¤¸à¤­à¥ à¤à¥à¤¬à¤²à¥à¤¸ à¤à¤° à¤à¥à¤²à¤®à¥à¤¸ source of truth (schema.sql) à¤à¥ à¤¸à¤¾à¤¥ sync à¤®à¥à¤ à¤¹à¥à¤à¥¤</p>
                      </div>
                    </div>
                  ) : (
                    <div className="space-y-8">
                      <div className="p-4 bg-amber-500/10 border border-amber-500/20 rounded-2xl flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-sm font-semibold text-amber-500 mb-1">à¤®à¤¾à¤à¤à¥à¤°à¥à¤¶à¤¨ à¤à¤µà¤¶à¥à¤¯à¤ à¤¹à¥</h4>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-surface-900 border border-surface-800 rounded-3xl w-full max-w-md p-6 relative max-h-[90vh] overflow-y-auto">
            <h3 className="text-base font-bold text-white mb-4">
              {userModal.mode === 'create' ? 'à¤¨à¤¯à¤¾ à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤ªà¤à¤à¥à¤à¥à¤¤ à¤à¤°à¥à¤' : 'à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤à¤¾à¤¨à¤à¤¾à¤°à¥ à¤à¤ªà¤¡à¥à¤ à¤à¤°à¥à¤'}
            </h3>
            
            <form onSubmit={saveUser} className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤à¤®à¥à¤² à¤à¤¡à¥à¤°à¥à¤¸</label>
                <input 
                  type="email" 
                  required
              ...
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤à¤ªà¤¯à¥à¤à¤à¤°à¥à¤¤à¤¾ à¤à¤¾ à¤¨à¤¾à¤®</label>
                <input 
                  type="text" 
              ...
              <div className="flex items-center gap-3 py-2">
                ...
                />
                <label htmlFor="is_registered" className="text-xs text-surface-300 font-medium">à¤ªà¤à¤à¥à¤à¤°à¤£ à¤à¥ à¤¸à¤à¥à¤°à¤¿à¤¯ à¤°à¥à¤ª à¤¸à¥ à¤¸à¤à¥à¤·à¤® à¤à¤°à¥à¤ (Active Registration)</label>
              </div>
      ...
      {workspaceModal.open && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-surface-900 border border-surface-800 rounded-3xl w-full max-w-md p-6 relative max-h-[90vh] overflow-y-auto">
            <h3 className="text-base font-bold text-white mb-4">
              {workspaceModal.mode === 'create' ? 'à¤¨à¤¯à¤¾ à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤¬à¤¨à¤¾à¤à¤' : 'à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤à¥à¤¨à¥à¤«à¤¼à¤¿à¤à¤° à¤à¤°à¥à¤'}
            </h3>
            
            <form onSubmit={saveWorkspace} className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸ à¤¨à¤¾à¤®</label>
                <input 
                  type="text" 
                  required
                  placeholder="à¤à¤¦à¤¾. à¤®à¤¾à¤°à¥à¤à¥à¤à¤¿à¤à¤ à¤µà¤°à¥à¤à¤¸à¥à¤ªà¥à¤¸"
              ...
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤¸à¤¦à¤¸à¥à¤¯à¤¤à¤¾ à¤¯à¥à¤à¤¨à¤¾ (Plan)</label>
                <select 
                  value={workspaceForm.plan_id}
                  onChange={e => setWorkspaceForm(prev => ({ ...prev, plan_id: e.target.value }))}
                  className="w-full px-4 py-2.5 bg-surface-950 border border-surface-800 rounded-xl text-xs text-white focus:outline-none focus:border-primary-500"
                >
                  <option value="">à¤à¥à¤ à¤¸à¤¦à¤¸à¥à¤¯à¤¤à¤¾ à¤¨à¤¹à¥à¤ (No Plan)</option>
                  {plans.map(p => (
                    <option key={p.id} value={p.id}>{p.name} (â¹{p.upfront_price}/mo)</option>
                  ))}
                </select>
              </div>

              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤¸à¥à¤µà¤¾à¤®à¥ (Owner) ID {workspaceModal.mode === 'create' && '- à¤µà¥à¤à¤²à¥à¤ªà¤¿à¤'}</label>
                <input 
                  type="text" 
                  placeholder="à¤à¤¦à¤¾. user-uuid-1234"
                  value={workspaceForm.owner_id}
                  onChange={e => setWorkspaceForm(prev => ({ ...prev, owner_id: e.target.value }))}
                  className="w-full px-4 py-2.5 bg-surface-950 border border-surface-800 rounded-xl text-xs text-white focus:outline-none focus:border-primary-500"
                />
                {workspaceModal.mode === 'edit' && (
                  <p className="text-[10px] text-surface-500 mt-1">à¤à¤¾à¤²à¥ à¤°à¤à¤¨à¥ à¤ªà¤° à¤®à¥à¤à¥à¤¦à¤¾ owner à¤¬à¤¨à¤¾ à¤°à¤¹à¥à¤à¤¾à¥¤</p>
                )}
              </div>
      ...
      {planModal.open && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-surface-900 border border-surface-800 rounded-3xl w-full max-w-md p-6 relative max-h-[90vh] overflow-y-auto">
            <h3 className="text-base font-bold text-white mb-4">
              {planModal.mode === 'create' ? 'à¤¨à¤¯à¤¾ à¤¸à¤¦à¤¸à¥à¤¯à¤¤à¤¾ à¤ªà¥à¤²à¤¾à¤¨ à¤à¥à¤¡à¤¼à¥à¤' : 'à¤ªà¥à¤²à¤¾à¤¨ à¤à¥à¤¨à¥à¤«à¤¼à¤¿à¤à¤°à¥à¤¶à¤¨ à¤µà¤¿à¤µà¤°à¤£'}
            </h3>
            
            <form onSubmit={savePlan} className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤ªà¥à¤²à¤¾à¤¨ ID (ID name)</label>
                <input 
                  type="text" 
                  required
                  placeholder="à¤à¤¦à¤¾. tier_pro, enterprise"
                  value={planForm.id}
              ...
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤ªà¥à¤²à¤¾à¤¨ à¤¨à¤¾à¤® (Display Name)</label>
                <input 
                  type="text" 
                  required
                  placeholder="à¤à¤¦à¤¾. Pro Business, Free Starter"
                  value={planForm.name}
              ...
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤µà¤¿à¤µà¤°à¤£ (Description)</label>
                <textarea 
                  placeholder="à¤ªà¥à¤²à¤¾à¤¨ à¤à¥ à¤®à¥à¤à¥à¤¯ à¤¬à¤¾à¤¤à¥à¤ à¤à¤¾ à¤¸à¤à¤à¥à¤·à¥à¤ª à¤®à¥à¤ à¤µà¤°à¥à¤£à¤¨ à¤à¤°à¥à¤"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤®à¤¾à¤¸à¤¿à¤ à¤®à¥à¤²à¥à¤¯ (â¹)</label>
                  <input 
                    type="number" 
                    required
                    placeholder="0"
                ...
                <div>
                  <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">PAYG à¤¸à¤à¤¦à¥à¤¶ à¤¦à¤° (â¹)</label>
                  <input 
                    type="number" 
                    step="0.01"
                    required
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤¬à¤¿à¤²à¤¿à¤à¤ à¤ªà¥à¤°à¤à¤¾à¤° (Billing Type)</label>
                  <select
                ...
                <div>
                  <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤à¤µà¤§à¤¿ (Period)</label>
                  <select
                ...
                <div>
                  <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">Interval (à¤¹à¤° N à¤à¤µà¤§à¤¿)</label>
                  <input
                    type="number"
                    min="1"
                ...
                <div>
                  <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤®à¥à¤¦à¥à¤°à¤¾ (Currency)</label>
                  <select
                ...
                <div>
                  <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤à¥à¤°à¤® (Sort Order)</label>
                  <input
                    type="number"
              ...
              <div className="flex items-center gap-5 py-1">
                ...
                <label className="flex items-center gap-2 text-xs text-surface-300 font-medium cursor-pointer">
                  ...
                  />
                  Free Plan (à¤¡à¤¿à¤«à¤¼à¥à¤²à¥à¤ / downgrade)
                </label>
              </div>

              
              <div className="space-y-3 pt-2 border-t border-surface-800">
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider">à¤à¤®à¥à¤² à¤²à¤¿à¤®à¤¿à¤à¥à¤¸ (Plan Email Limits)</label>
                <div className="grid grid-cols-2 gap-3">
                  <div>
...
<div className="space-y-2">
                <div className="flex justify-between items-center mb-1">
                  <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider">à¤¸à¥à¤µà¤¿à¤§à¤¾à¤à¤ (Features)</label>
                  <button
                    type="button"
                ...
                {planForm.features.map((f, i) => (
                  <div key={f.id} className="flex gap-2">
                    <input
                      type="text"
                      placeholder="à¤à¤¦à¤¾. Unlimited Messages"
                      value={f.value}
                      onChange={e => {
              ...
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-3">Limits (à¤¸à¥à¤®à¤¾à¤à¤)</label>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="block text-[10px] text-surface-500 mb-1">Email Monthly Limit</label>
                    <input
                      type="number"
                      placeholder="à¤à¤¦à¤¾. 1000"
                      value={planForm.limits?.email_monthly_limit || ''}
                      onChange={e => setPlanForm(prev => ({ ...prev, limits: { ...prev.limits, email_monthly_limit: e.target.value } }))}
      ...
      {kvModal.open && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-surface-900 border border-surface-800 rounded-3xl w-full max-w-md p-6 relative max-h-[90vh] overflow-y-auto">
            <h3 className="text-base font-bold text-white mb-4">
              {kvModal.data ? 'KV à¤¸à¥à¤à¥à¤°à¥à¤ à¤à¥à¤à¤à¥ à¤à¤ªà¤¡à¥à¤ à¤à¤°à¥à¤' : 'à¤¨à¤¯à¤¾ KV à¤à¥à¤à¤à¥-à¤®à¥à¤²à¥à¤¯ à¤¸à¤¹à¥à¤à¥à¤'}
            </h3>
            
            <form onSubmit={saveKvSecret} className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤à¥à¤à¤à¥ (Key Name)</label>
                <input 
                  type="text" 
                  required
                  placeholder="à¤à¤¦à¤¾. WHATSAPP_API_TOKEN, FB_APP_ID"
                  value={kvForm.name}
              ...
              <div>
                <label className="block text-[10px] font-bold text-surface-500 uppercase tracking-wider mb-2">à¤®à¥à¤²à¥à¤¯ (Value string)</label>
                <textarea 
                  required
