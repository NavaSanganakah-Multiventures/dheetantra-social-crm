      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-lg text-surface-500 dark:text-surface-400 max-w-xl mx-auto">
            Choose the plan that fits your business. Pay-as-you-go rates with
            upfront options for advanced features.
          </p>
        </motion.div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-6 space-y-1 pb-6 border-b border-surface-200 dark:border-surface-700/50">
                    ...
                    >
                      + ${plan.pay_as_you_go_rate} / message
                    </div>
                  </div>
                  ...
                  <Link
                    href="/register"
                    className={`block w-full text-center font-medium rounded-xl py-3.5 transition-all text-sm ${
                      isPopular
