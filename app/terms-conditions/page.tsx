  ...
  return (
    <div className="min-h-screen bg-surface-50 dark:bg-surface-950 font-sans selection:bg-primary-500/30">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <h1 className="text-4xl md:text-5xl font-bold font-display text-surface-900 dark:text-white mb-8">Terms & Conditions</h1>
        ...
        <div className="space-y-8 text-surface-600 dark:text-surface-400 leading-relaxed">
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-surface-900 dark:text-white">1. Acceptance of Terms</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-surface-900 dark:text-white">2. Description of Service</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-surface-900 dark:text-white">3. User Account Responsibilities</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-surface-900 dark:text-white">4. Acceptable Use Policy</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-surface-900 dark:text-white">5. Limitation of Liability</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-surface-900 dark:text-white">6. Modifications to Terms</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl font-bold font-display text-surface-900 dark:text-white">7. Contact Information</h2>
            <p>If you have any questions about these Terms, please contact us at <a href="mailto:support@dheetantra.com" className="text-primary-600 dark:text-primary-400 hover:underline">support@dheetantra.com</a>.</p>
          </section>
        </div>
      </div>
    </div>
